    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="pf-stat">
                ...
                <div class="pf-stat-value">{{ Auth::user()->prompts()->whereMonth('created_at', now()->month)->count() }}
                </div>
            </div>
        </div>
            ...
            <div class="pf-card p-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <a href="{{ route('prompts.index') }}"
                        style="font-size:13px; color:#5b5ef4; text-decoration:none;">View all →</a>
                </div>
                ...
                @forelse($recent as $prompt)
                    <div class="d-flex align-items-center justify-content-between py-2"
                        ...
                        <a href="{{ route('prompts.show', $prompt) }}"
                            style="font-size:12px; color:#5b5ef4; text-decoration:none;">View</a>
                    </div>
                @empty
            ...
            <div class="pf-card p-4">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('prompts.create') }}"
                        class="btn-pf-primary text-center text-decoration-none py-2">
