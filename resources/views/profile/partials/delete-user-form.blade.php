<section>
    <div class="mb-4">
        ...
        <div style="font-size:13px; color:#6c757d;">Once deleted, all your prompts and data will be permanently removed.
        </div>
    </div>
            ...
            <form method="post" action="{{ route('profile.destroy') }}" class="modal-content"
                ...
                <div class="modal-body">
                    <p style="font-size:13px; color:#6c757d; margin-bottom:1rem;">
                        This action is irreversible. All your prompts and data will be permanently deleted. Enter your
                        password to confirm.
                    </p>

                    @if ($errors->userDeletion->any())
                        <div
                            style="background:#fef2f2; border:1px solid #fecaca; border-radius:8px; padding:.65rem .85rem; font-size:13px; color:#dc2626; margin-bottom:1rem;">
                    ...
                    <input id="delete_password" type="password" name="password" class="pf-input"
